...
const C = {
  hero:       'from-green-50 via-yellow-50 to-green-100',
  heroBorder: 'border-green-100',
  blob1:      'bg-green-200',
  blob2:      'bg-yellow-200',
  wave:       '#FFFFFF',
  badge:      'bg-green-100 border-green-300 text-neutral-700',
  badgeDot:   'bg-green-500',
  heading:    'text-neutral-700',
  stat:       'text-neutral-700',
  statBorder: 'border-green-100',
  sectionIcon:'bg-green-100 border-green-200 text-neutral-700',
  sectionLine:'from-green-200',
  cardBorder: 'border-green-100',
  cardAccent: 'bg-green-50',
  highlight:  'text-neutral-600',
  stepNum:    'bg-green-100 border-green-300 text-neutral-700',
  schemeBg:   'from-green-50 to-yellow-50 border-green-200',
  schemeStrong:'text-neutral-700',
  targetBg:   'bg-green-50 border-green-100',
  ctaBg:      'from-green-50 to-yellow-50 border-green-200',
  ctaBtn:     'bg-black hover:bg-neutral-800',
  tagBg:      'bg-green-50 border-green-200 text-neutral-700',
  navBtn:     'bg-white border-green-200 hover:border-green-400 text-neutral-800',
  backBtn:    'bg-black hover:bg-neutral-800',
  productBar: 'from-green-700 via-green-500 to-yellow-400',
};
    ...
    <div className="min-h-screen bg-[#FFFFFF] font-[Inter,sans-serif] text-[#0A0A0A]">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <p className="text-xs text-neutral-700 font-semibold tracking-wide">{branding.brandName}</p>
              </div>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20">
        ...
        <section className="py-12">
          <div className="bg-white rounded-2xl border border-green-100 shadow-sm p-8">
            ...
            <div className="flex items-start gap-4 mb-8">
              ...
              <div>
                <p className="text-xs font-bold tracking-widest text-neutral-600 uppercase mb-1">Surat Penawaran Kerjasama</p>
                <h2 className="pf text-2xl font-bold text-[#0A0A0A]">Kepada Yth.<br />Pimpinan / Pengelola Toko</h2>
                <p className="text-xs text-[#0A0A0A]/40 mt-1">di Tempat</p>
              </div>
            </div>

            <div className="text-[#0A0A0A]/80 leading-relaxed space-y-5 text-[15px]">
              <p>Assalamu&apos;alaikum Wr. Wb.</p>

              <p>
                Dengan hormat, perkenalkan kami dari <strong className="text-neutral-700">{branding.brandName}</strong> — usaha camilan rumahan yang berbasis di <strong>Bogor, Jawa Barat</strong>, terdaftar resmi dengan <strong>NIB: 0403260068412</strong> dan produk bersertifikat <strong>Halal Indonesia</strong>. Melalui surat ini, kami mengajukan penawaran kerjasama pemasaran produk unggulan kami, <strong className="text-neutral-700">Mie Kremes</strong>, untuk dapat dipasarkan di tempat yang Bapak/Ibu kelola.
              </p>
              ...
              <div className="bg-green-50 border border-green-100 rounded-xl p-5 my-6">
                <p className="text-xs font-bold tracking-widest text-neutral-600 uppercase mb-3">Ringkasan Produk</p>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
                  {[
                    ...
                    <div key={i.label}>
                      <p className="text-[#0A0A0A]/50 text-xs">{i.label}</p>
                      <p className="font-semibold text-[#0A0A0A]">{i.value}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="space-y-4 pl-1">
                <div className="flex gap-3">
                  <div className="w-7 h-7 rounded-full bg-green-100 border border-green-300 text-neutral-700 font-bold text-sm flex items-center justify-center flex-shrink-0 mt-0.5">1</div>
                  <div>
                    <p className="font-semibold text-[#0A0A0A] mb-1">Titip Jual (Konsinyasi)</p>
                    <p className="text-sm text-[#0A0A0A]/70 leading-relaxed">
                      Produk kami titipkan di toko Bapak/Ibu <strong>tanpa biaya awal</strong>. Harga pengambilan ditetapkan <strong className="text-neutral-700">Rp 9.000/pcs</strong>, dan Bapak/Ibu bebas menentukan harga jual ke konsumen (kami sarankan minimal Rp 10.000). Pembayaran dilakukan berdasarkan jumlah produk yang <em>terjual</em> saja, dengan periode mingguan atau bulanan sesuai kesepakatan. Produk yang tidak terjual atau mendekati kedaluarsa akan kami ganti — <strong>risiko stok sepenuhnya kami tanggung</strong>.
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <div className="w-7 h-7 rounded-full bg-green-100 border border-green-300 text-neutral-700 font-bold text-sm flex items-center justify-center flex-shrink-0 mt-0.5">2</div>
                  <div>
                    <p className="font-semibold text-[#0A0A0A] mb-1">Beli Putus (Reseller)</p>
                    <p className="text-sm text-[#0A0A0A]/70 leading-relaxed">
                      Bapak/Ibu membeli produk secara langsung (<strong>cash</strong>) dengan pilihan paket mulai dari <strong>10 pcs (Rp 90.000)</strong> hingga <strong>30 pcs (Rp 240.000)</strong>. Semakin banyak yang dibeli, semakin murah harga per satuannya. Bapak/Ibu bebas menentukan harga jual sendiri dan mendapatkan potensi untung hingga <strong className="text-neutral-600">Rp 60.000 per paket</strong>. Detail paket lengkap tersedia di halaman ini.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-12">
          <ST icon="🤝" label="Mekanisme Kerjasama" title="2 Pilihan Cara Kerjasama" accent="text-neutral-600" iconBg="bg-green-100 border-green-200" line="from-green-200" />
          <p className="text-sm text-[#0A0A0A]/50 mt-4 mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <div className="bg-white rounded-2xl border-2 border-green-200 overflow-hidden shadow-sm">
              <div className="bg-gradient-to-br from-green-50 to-green-50 px-6 py-5 border-b border-green-100">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-3xl">🤝</span>
                  <div>
                    <p className="text-xs font-bold tracking-widest text-neutral-500 uppercase">Mekanisme 1</p>
                    <h3 className="pf text-xl font-bold text-[#0A0A0A]">Titip Jual</h3>
                  </div>
                </div>
                <span className="inline-block bg-green-100 border border-green-300 text-neutral-700 text-xs font-semibold px-3 py-1 rounded-full">Tanpa Modal Awal</span>
              </div>
              <div className="p-6">
                <div className="space-y-2.5 mb-5 text-sm">
                  <div className="flex justify-between pb-2 border-b border-green-50">
                    <span className="text-[#0A0A0A]/60">Harga Pengambilan</span>
                    <span className="font-bold text-neutral-700">Rp 9.000 / pcs</span>
                  </div>
                  <div className="flex justify-between pb-2 border-b border-green-50">
                    <span className="text-[#0A0A0A]/60">Harga Jual ke Konsumen</span>
                    <span className="font-semibold text-[#0A0A0A]">Bebas (saran Rp 10.000+)</span>
                  </div>
                  <div className="flex justify-between pb-2 border-b border-green-50">
                    <span className="text-[#0A0A0A]/60">Estimasi Margin Toko</span>
                    <span className="font-bold text-neutral-600">min. Rp 1.000 / pcs</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[#0A0A0A]/60">Sistem Pembayaran</span>
                    <span className="font-semibold text-[#0A0A0A]">Mingguan / Bulanan</span>
                  </div>
                </div>
                <div className="space-y-2">
                  {[
                    ...
                    <div key={p} className="flex gap-2 text-sm text-[#0A0A0A]/70">
            ...
            <div className="relative bg-white rounded-2xl border-2 border-green-400 overflow-hidden shadow-md">
              ...
              <div className="bg-gradient-to-br from-green-100 to-green-100 px-6 pt-9 pb-5 border-b border-green-200">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-3xl">💼</span>
                  <div>
                    <p className="text-xs font-bold tracking-widest text-neutral-600 uppercase">Mekanisme 2</p>
                    <h3 className="pf text-xl font-bold text-[#0A0A0A]">Beli Putus / Reseller</h3>
                  </div>
                </div>
                <span className="inline-block bg-green-200 border border-green-300 text-neutral-800 text-xs font-semibold px-3 py-1 rounded-full">Bayar Langsung / Cash</span>
              </div>
              <div className="p-6">
                <div className="space-y-2.5 mb-5 text-sm">
                  <div className="flex justify-between pb-2 border-b border-green-50">
                    <span className="text-[#0A0A0A]/60">Harga Per Pcs</span>
                    <span className="font-bold text-neutral-700">Rp 8.000 – 9.000</span>
                  </div>
                  <div className="flex justify-between pb-2 border-b border-green-50">
                    <span className="text-[#0A0A0A]/60">Harga Jual ke Konsumen</span>
                    <span className="font-semibold text-[#0A0A0A]">Bebas (saran Rp 10.000)</span>
                  ...
                  <div className="flex justify-between pb-2 border-b border-green-50">
                    <span className="text-[#0A0A0A]/60">Potensi Margin</span>
                    <span className="font-bold text-neutral-600">Rp 1.000 – 2.000 / pcs</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[#0A0A0A]/60">Sistem Pembayaran</span>
                    <span className="font-semibold text-[#0A0A0A]">Cash / Bayar Langsung</span>
                  </div>
                </div>
                <div className="space-y-2">
                  {[
          ...
          <p className="text-xs text-[#0A0A0A]/40 mt-4 text-center">
        ...
        {/* ── PRODUK ── */}
        <section className="mb-12">
          <ST icon="🍝" label="Katalog Produk" title="Detail Produk Mie Kremes" accent="text-neutral-600" iconBg="bg-green-100 border-green-200" line="from-green-200" />
          <div className="grid md:grid-cols-2 gap-5 mt-6">
            ...
            <div className="bg-white rounded-2xl border border-green-100 overflow-hidden shadow-sm">
              <div className="relative h-40 overflow-hidden">
                ...
                <span className="absolute bottom-3 right-3 bg-black text-white text-[10px] font-bold px-2.5 py-1 rounded-full">Best Seller</span>
              </div>
              <div className="p-6">
                <div className="mb-4">
                  <h3 className="pf text-xl font-bold text-[#0A0A0A]">Mie Kremes Original</h3>
                </div>
                ...
                <div className="space-y-2 mb-5">
                  {[
                    ...
                    <div key={k} className="flex gap-3 text-sm">
                      <span className="text-neutral-500 font-semibold w-28 flex-shrink-0">{k}</span>
                      <span className="text-[#0A0A0A]/70">{v}</span>
                    </div>
                  ))}
                </div>
                <div className="flex items-baseline gap-2 pt-4 border-t border-green-50">
                  <span className="pf text-2xl font-bold text-neutral-700">Rp 10.000</span>
                  <span className="text-xs text-[#0A0A0A]/40">/ kemasan 150g</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-red-100 overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <div className="mb-4">
                  <h3 className="pf text-xl font-bold text-[#0A0A0A]">Mie Kremes Pedas</h3>
                </div>
                <p className="text-sm text-[#0A0A0A]/60 leading-relaxed mb-4">
          ...
          <div className="mt-5 bg-green-50 border border-green-200 rounded-2xl p-5">
            <p className="text-xs font-bold tracking-widest text-neutral-600 uppercase mb-3">Ringkasan Harga Jual</p>
            <div className="grid grid-cols-2 gap-3">
              {[
                { name: 'Mie Kremes Original', price: 'Rp 10.000', weight: '150g' },
                { name: 'Mie Kremes Pedas', price: 'Rp 10.000', weight: '150g' },
              ].map(p => (
                <div key={p.name} className="bg-white rounded-xl border border-green-100 p-4 flex justify-between items-center">
                  <div>
                    <p className="font-semibold text-sm text-[#0A0A0A]">{p.name}</p>
                    <p className="text-xs text-[#0A0A0A]/50">{p.weight}</p>
                  </div>
                  <p className="pf font-bold text-neutral-700">{p.price}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* ── PAKET RESELLER ── */}
        <section className="mb-12">
          <ST icon="💼" label="Paket Reseller" title="Harga &amp; Paket Reseller" accent="text-neutral-600" iconBg="bg-green-100 border-green-200" line="from-green-200" />
          <p className="text-sm text-[#0A0A0A]/50 mt-4 mb-5">
            Harga jual ke konsumen: <strong className="text-neutral-700">Rp 10.000/pcs</strong>. Semakin banyak order, semakin besar keuntungan Anda.
          </p>
          <div className="grid md:grid-cols-3 gap-5">

            {/* Krenyes Pemula */}
            <div className="bg-white rounded-2xl border-2 border-green-200 overflow-hidden shadow-sm">
              <div className="bg-gradient-to-br from-green-500 to-yellow-400 px-6 py-5 text-white text-center">
              ...
              <div className="p-5 space-y-3">
                <div className="text-center">
                  <p className="text-xs text-[#0A0A0A]/50 mb-0.5">Modal Awal</p>
                  <p className="pf text-2xl font-bold gradient-text">Rp 90.000</p>
                  <p className="text-xs text-[#0A0A0A]/40">= Rp 9.000/pcs</p>
                </div>
                <div className="h-px bg-green-50" />
                <div className="flex justify-between text-sm"><span className="text-[#0A0A0A]/60">Harga Jual</span><span className="font-semibold text-[#0A0A0A]">Rp 10.000/pcs</span></div>
                <div className="flex justify-between text-sm"><span className="text-[#0A0A0A]/60">Potensi Omset</span><span className="font-semibold text-[#0A0A0A]">Rp 100.000</span></div>
                <div className="flex justify-between text-sm"><span className="text-[#0A0A0A]/60">Potensi Untung</span><span className="font-bold text-neutral-600">Rp 10.000</span></div>
              </div>
            </div>
            ...
            <div className="relative bg-white rounded-2xl border-2 border-green-400 overflow-hidden shadow-md">
              ...
              <div className="p-5 space-y-3">
                <div className="text-center">
                  ...
                  <p className="text-xs text-[#0A0A0A]/40">= Rp 8.500/pcs</p>
                </div>
                <div className="h-px bg-green-50" />
                <div className="flex justify-between text-sm"><span className="text-[#0A0A0A]/60">Harga Jual</span><span className="font-semibold text-[#0A0A0A]">Rp 10.000/pcs</span></div>
                <div className="flex justify-between text-sm"><span className="text-[#0A0A0A]/60">Potensi Omset</span><span className="font-semibold text-[#0A0A0A]">Rp 200.000</span></div>
                <div className="flex justify-between text-sm"><span className="text-[#0A0A0A]/60">Potensi Untung</span><span className="font-bold text-neutral-600">Rp 30.000</span></div>
              </div>
            </div>

            {/* Kriuk Maksimal */}
            <div className="bg-white rounded-2xl border-2 border-rose-100 overflow-hidden shadow-sm">
              <div className="bg-gradient-to-br from-rose-500 to-green-400 px-6 py-5 text-white text-center">
                <div className="text-4xl mb-2">💎</div>
              ...
              <div className="p-5 space-y-3">
                <div className="text-center">
                  ...
                  <p className="text-xs text-[#0A0A0A]/40">= Rp 8.000/pcs</p>
                </div>
                <div className="h-px bg-rose-50" />
                <div className="flex justify-between text-sm"><span className="text-[#0A0A0A]/60">Harga Jual</span><span className="font-semibold text-[#0A0A0A]">Rp 10.000/pcs</span></div>
                <div className="flex justify-between text-sm"><span className="text-[#0A0A0A]/60">Potensi Omset</span><span className="font-semibold text-[#0A0A0A]">Rp 300.000</span></div>
                <div className="flex justify-between text-sm"><span className="text-[#0A0A0A]/60">Potensi Untung</span><span className="font-bold text-neutral-600">Rp 60.000</span></div>
              </div>
            </div>
          </div>
          <div className="mt-5 flex flex-col sm:flex-row items-center justify-between gap-3 bg-green-50 border border-green-200 rounded-2xl px-5 py-4">
            <p className="text-xs text-[#0A0A0A]/50 text-center sm:text-left">* Bebas mix rasa Original &amp; Pedas. Harga belum termasuk ongkos kirim.</p>
            <a href="/reseller" target="_blank" rel="noopener noreferrer" className="no-print inline-flex items-center gap-2 bg-black hover:bg-neutral-800 text-white text-xs font-semibold px-4 py-2 rounded-xl transition-colors whitespace-nowrap">
              Daftar Reseller →
            </a>
          </div>
        </section>
        ...
        {/* ── KEUNGGULAN ── */}
        <section className="mb-12">
          <ST icon="⭐" label="Keunggulan" title="Mengapa Mie Kremes?" accent="text-neutral-600" iconBg="bg-green-100 border-green-200" line="from-green-200" />
        ...
        {/* ── TARGET PASAR ── */}
        <section className="mb-12">
          <ST icon="🎯" label="Target Pasar" title="Cocok Dijual Di Mana?" accent="text-neutral-600" iconBg="bg-green-100 border-green-200" line="from-green-200" />
        ...
        {/* ── LEGALITAS ── */}
        <section className="mb-12">
          <ST icon="📜" label="Legalitas" title="Legalitas &amp; Kepercayaan" accent="text-neutral-600" iconBg="bg-green-100 border-green-200" line="from-green-200" />
          <div className="grid md:grid-cols-3 gap-4 mt-6">
            {[
              ...
              <div key={item.t} className="bg-white rounded-xl border border-green-100 p-6 text-center">
                ...
                <p className="text-xs text-neutral-700 font-semibold mb-2">{item.sub}</p>
        ...
        <section>
          <div className={`bg-gradient-to-br ${C.ctaBg} border rounded-2xl p-8 text-center`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8 no-print">
              <a href={branding.whatsappUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-black hover:bg-neutral-800 text-white font-semibold px-7 py-3 rounded-xl transition-colors">
              ...
              <a href="/" className="inline-flex items-center justify-center gap-2 bg-black hover:bg-neutral-800 text-white font-semibold px-7 py-3 rounded-xl transition-colors">
                🛒 Toko Saya
              </a>
            </div>
            <div className="grid sm:grid-cols-3 gap-3 text-sm">
              <a href={branding.whatsappUrl} target="_blank" rel="noopener noreferrer" className="bg-white rounded-xl border border-green-100 p-3 hover:border-green-300 transition-colors">
                ...
                <div className="text-xs text-neutral-700 font-semibold">WhatsApp</div>
              ...
              <a href="/" className="bg-white rounded-xl border border-green-100 p-3 hover:border-green-300 transition-colors">
                <div className="text-xl mb-1">🛒</div>
                <div className="text-xs text-neutral-700 font-semibold">Toko Online</div>
                <div className="text-neutral-600 font-medium text-xs mt-0.5 underline underline-offset-2">Kunjungi Toko Kami</div>
              </a>
              <div className="bg-white rounded-xl border border-green-100 p-3">
                <div className="text-xl mb-1">📍</div>
                <div className="text-xs text-neutral-700 font-semibold">Lokasi</div>
