      ...
      <div className="max-w-4xl mx-auto px-6 pt-10 pb-2">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={c.label} className="bg-white rounded-2xl p-4 text-center border border-orange-100 shadow-sm hover:shadow-md hover:shadow-orange-100 transition-all duration-300">
