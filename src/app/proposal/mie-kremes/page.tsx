...
const C = {
  ...
  sectionIcon:'bg-green-100 border-green-200 text-green-700',
  sectionLine:'from-green-200',
  cardBorder: 'border-green-100',
  cardAccent: 'bg-green-50',
  highlight:  'text-green-600',
  stepNum:    'bg-green-100 border-green-300 text-green-700',
  schemeBg:   'from-green-50 to-yellow-50 border-green-200',
  schemeStrong:'text-green-700',
  ...
  tagBg:      'bg-green-50 border-green-200 text-green-700',
  navBtn:     'bg-white border-green-200 hover:border-green-400 text-green-800',
  backBtn:    'bg-green-500 hover:bg-green-600',
    ...
    <div className="min-h-screen bg-[#FFFFFF] font-[Inter,sans-serif] text-[#0A0A0A]">
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20">
        ...
        <section className="py-12">
          <div className="bg-white rounded-2xl border border-green-100 shadow-sm p-8">
            ...
            <div className="flex items-start gap-4 mb-8">
              ...
              <div>
                <p className="text-xs font-bold tracking-widest text-green-600 uppercase mb-1">Surat Penawaran Kerjasama</p>
            ...
            <div className="text-[#0A0A0A]/80 leading-relaxed space-y-5 text-[15px]">
              ...
              <p>
                Dengan hormat, perkenalkan kami dari <strong className="text-green-700">{branding.brandName}</strong> — usaha camilan rumahan yang berbasis di <strong>Bogor, Jawa Barat</strong>, terdaftar resmi dengan <strong>NIB: 0403260068412</strong> dan produk bersertifikat <strong>Halal Indonesia</strong>. Melalui surat ini, kami mengajukan penawaran kerjasama pemasaran produk unggulan kami, <strong className="text-green-700">Mie Kremes</strong>, untuk dapat dipasarkan di tempat yang Bapak/Ibu kelola.
              </p>
              ...
              <div className="bg-green-50 border border-green-100 rounded-xl p-5 my-6">
                <p className="text-xs font-bold tracking-widest text-green-600 uppercase mb-3">Ringkasan Produk</p>
              ...
              <div className="space-y-4 pl-1">
                <div className="flex gap-3">
                  <div className="w-7 h-7 rounded-full bg-green-100 border border-green-300 text-green-700 font-bold text-sm flex items-center justify-center flex-shrink-0 mt-0.5">1</div>
                  <div>
                    <p className="font-semibold text-[#0A0A0A] mb-1">Titip Jual (Konsinyasi)</p>
                    <p className="text-sm text-[#0A0A0A]/70 leading-relaxed">
                      Produk kami titipkan di toko Bapak/Ibu <strong>tanpa biaya awal</strong>. Harga pengambilan ditetapkan <strong className="text-green-700">Rp 9.000/pcs</strong>, dan Bapak/Ibu bebas menentukan harga jual ke konsumen (kami sarankan minimal Rp 10.000). Pembayaran dilakukan berdasarkan jumlah produk yang <em>terjual</em> saja, dengan periode mingguan atau bulanan sesuai kesepakatan. Produk yang tidak terjual atau mendekati kedaluarsa akan kami ganti — <strong>risiko stok sepenuhnya kami tanggung</strong>.
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <div className="w-7 h-7 rounded-full bg-green-100 border border-green-300 text-green-700 font-bold text-sm flex items-center justify-center flex-shrink-0 mt-0.5">2</div>
                  <div>
        ...
        <section className="mb-12">
          <ST icon="🤝" label="Mekanisme Kerjasama" title="2 Pilihan Cara Kerjasama" accent="text-green-600" iconBg="bg-green-100 border-green-200" line="from-green-200" />
            ...
            <div className="bg-white rounded-2xl border-2 border-green-200 overflow-hidden shadow-sm">
              <div className="bg-gradient-to-br from-green-50 to-green-50 px-6 py-5 border-b border-green-100">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className="text-xs font-bold tracking-widest text-green-500 uppercase">Mekanisme 1</p>
              ...
              <div className="p-6">
                <div className="space-y-2.5 mb-5 text-sm">
                  <div className="flex justify-between pb-2 border-b border-green-50">
                    ...
                    <span className="font-bold text-green-700">Rp 9.000 / pcs</span>
                  </div>
                  <div className="flex justify-between pb-2 border-b border-green-50">
            ...
            <div className="relative bg-white rounded-2xl border-2 border-green-400 overflow-hidden shadow-md">
              ...
              <div className="bg-gradient-to-br from-green-100 to-green-100 px-6 pt-9 pb-5 border-b border-green-200">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-3xl">💼</span>
                  <div>
                    <p className="text-xs font-bold tracking-widest text-green-600 uppercase">Mekanisme 2</p>
                    <h3 className="pf text-xl font-bold text-[#0A0A0A]">Beli Putus / Reseller</h3>
                  </div>
                </div>
                <span className="inline-block bg-green-200 border border-green-300 text-green-800 text-xs font-semibold px-3 py-1 rounded-full">Bayar Langsung / Cash</span>
              </div>
              <div className="p-6">
                <div className="space-y-2.5 mb-5 text-sm">
                  <div className="flex justify-between pb-2 border-b border-green-50">
                    <span className="text-[#0A0A0A]/60">Harga Per Pcs</span>
                    <span className="font-bold text-green-700">Rp 8.000 – 9.000</span>
                  </div>
                  <div className="flex justify-between pb-2 border-b border-green-50">
                    <span className="text-[#0A0A0A]/60">Harga Jual ke Konsumen</span>
                    <span className="font-semibold text-[#0A0A0A]">Bebas (saran Rp 10.000)</span>
        ...
        {/* ── PRODUK ── */}
        <section className="mb-12">
          <ST icon="🍝" label="Katalog Produk" title="Detail Produk Mie Kremes" accent="text-green-600" iconBg="bg-green-100 border-green-200" line="from-green-200" />
          <div className="grid md:grid-cols-2 gap-5 mt-6">
            ...
            <div className="bg-white rounded-2xl border border-green-100 overflow-hidden shadow-sm">
              <div className="relative h-40 overflow-hidden">
                ...
                <span className="absolute bottom-3 right-3 bg-green-500 text-white text-[10px] font-bold px-2.5 py-1 rounded-full">Best Seller</span>
              </div>
              <div className="p-6">
                <div className="mb-4">
                ...
                <div className="space-y-2 mb-5">
                  {[
                    ...
                    <div key={k} className="flex gap-3 text-sm">
                      <span className="text-green-500 font-semibold w-28 flex-shrink-0">{k}</span>
                      <span className="text-[#0A0A0A]/70">{v}</span>
                    </div>
                  ))}
                </div>
                <div className="flex items-baseline gap-2 pt-4 border-t border-green-50">
                  <span className="pf text-2xl font-bold text-green-700">Rp 10.000</span>
          ...
          <div className="mt-5 bg-green-50 border border-green-200 rounded-2xl p-5">
            <p className="text-xs font-bold tracking-widest text-green-600 uppercase mb-3">Ringkasan Harga Jual</p>
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={p.name} className="bg-white rounded-xl border border-green-100 p-4 flex justify-between items-center">
                  ...
                  <p className="pf font-bold text-green-700">{p.price}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* ── PAKET RESELLER ── */}
        <section className="mb-12">
          <ST icon="💼" label="Paket Reseller" title="Harga &amp; Paket Reseller" accent="text-green-600" iconBg="bg-green-100 border-green-200" line="from-green-200" />
          <p className="text-sm text-[#0A0A0A]/50 mt-4 mb-5">
            Harga jual ke konsumen: <strong className="text-green-700">Rp 10.000/pcs</strong>. Semakin banyak order, semakin besar keuntungan Anda.
          </p>
          <div className="grid md:grid-cols-3 gap-5">
            ...
            <div className="bg-white rounded-2xl border-2 border-green-200 overflow-hidden shadow-sm">
              ...
              <div className="p-5 space-y-3">
                ...
                <div className="flex justify-between text-sm"><span className="text-[#0A0A0A]/60">Potensi Untung</span><span className="font-bold text-green-600">Rp 10.000</span></div>
              </div>
            </div>
            ...
            <div className="relative bg-white rounded-2xl border-2 border-green-400 overflow-hidden shadow-md">
              ...
              <div className="p-5 space-y-3">
                ...
                <div className="flex justify-between text-sm"><span className="text-[#0A0A0A]/60">Potensi Untung</span><span className="font-bold text-green-600">Rp 30.000</span></div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border-2 border-rose-100 overflow-hidden shadow-sm">
              ...
              <div className="p-5 space-y-3">
                ...
                <div className="flex justify-between text-sm"><span className="text-[#0A0A0A]/60">Potensi Untung</span><span className="font-bold text-green-600">Rp 60.000</span></div>
              </div>
            </div>
          </div>
          <div className="mt-5 flex flex-col sm:flex-row items-center justify-between gap-3 bg-green-50 border border-green-200 rounded-2xl px-5 py-4">
            ...
            <a href="/reseller" target="_blank" rel="noopener noreferrer" className="no-print inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold px-4 py-2 rounded-xl transition-colors whitespace-nowrap">
              Daftar Reseller →
            </a>
          </div>
        </section>
        ...
        {/* ── KEUNGGULAN ── */}
        <section className="mb-12">
          <ST icon="⭐" label="Keunggulan" title="Mengapa Mie Kremes?" accent="text-green-600" iconBg="bg-green-100 border-green-200" line="from-green-200" />
        ...
        {/* ── TARGET PASAR ── */}
        <section className="mb-12">
          <ST icon="🎯" label="Target Pasar" title="Cocok Dijual Di Mana?" accent="text-green-600" iconBg="bg-green-100 border-green-200" line="from-green-200" />
        ...
        {/* ── LEGALITAS ── */}
        <section className="mb-12">
          <ST icon="📜" label="Legalitas" title="Legalitas &amp; Kepercayaan" accent="text-green-600" iconBg="bg-green-100 border-green-200" line="from-green-200" />
