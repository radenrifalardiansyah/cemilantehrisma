  ...
  return (
    <main className="min-h-screen" style={{ background: '#FFFFFF' }}>
      ...
      <div className="max-w-md mx-auto px-4 pt-28 sm:pt-32 pb-20">
        <h1 className="font-display text-3xl font-bold text-neutral-950 mb-1">Masuk</h1>
        <p className="text-neutral-800/55 text-sm mb-8">Masuk ke akun untuk melanjutkan checkout.</p>
