...
export default function ProductDetailClient() {
  ...
  const Carousel = (
    <div>
      {/* Main image */}
      <div
        className="relative bg-white overflow-hidden rounded-none md:rounded-2xl md:border md:border-green-100 md:shadow-sm"
      ...
      {/* Thumbnails */}
      {hasMultiple && (
        <div className="bg-white md:bg-transparent border-b border-green-100 md:border-0 py-3 px-4 flex items-center justify-center gap-3 md:mt-3 md:justify-start">
          {images.map((img, i) => (
            <button
              key={i}
  ...
  const Info = (
    <div className="px-4 pt-5 pb-4 md:px-0 md:pt-0">
      ...
      {/* Description */}
      <FormattedText text={lp.description} className="text-green-800/75 text-sm leading-relaxed mb-5" />
  ...
  return (
    <div className="min-h-screen bg-green-50">
      ...
      <div className="sticky top-16 z-30 bg-green-50/90 backdrop-blur-md border-b border-green-100 md:hidden">
      ...
      <div className="md:hidden fixed left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-green-100 shadow-lg" style={{ bottom: 'calc(60px + env(safe-area-inset-bottom))' }}>
