    ...
    <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      >
        ...
        <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold">
          <span className="text-amber-950">Pilih </span>
          <span className="gradient-text">Menu Favoritmu</span>
        </h2>
        <p className="text-amber-800/55 text-sm sm:text-base mt-3 max-w-md mx-auto">
          Keripik Kimpul, Mie Kremes, hingga Paket Hemat — semua tersedia di satu tempat
        </p>
      </motion.div>
            ...
            <Link href={`/products?category=${cat.id}`}>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-amber-700/55 text-xs sm:text-sm mt-0.5">{cat.description}</p>
                  <div className="flex items-center justify-between mt-2">
                    <span className="text-amber-600/55 text-xs">{cat.count} menu</span>
                    <motion.div
