...
export default function ProductCard({ product, index = 0 }: Props) {
  ...
  const stockConfig = {
    ...
    open_po: { label: t.product.openPO,    Icon: Clock3,      color: '#ffffff', bg: 'linear-gradient(135deg, #16A34A, #16A34A)', border: 'transparent' },
  };
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        {/* Description */}
        <FormattedText text={lp.description} className="text-green-800/50 text-xs leading-relaxed line-clamp-2 mb-3" />
