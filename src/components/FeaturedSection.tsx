      ...
      >
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-neutral-600/70 text-sm font-semibold tracking-widest uppercase">
              {t.featured.badge}
            </p>
          </div>
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold">
            <span className="text-neutral-950">{t.featured.title1} </span>
            <span className="gradient-text">{t.featured.title2}</span>
          </h2>
          <p className="text-neutral-800/55 text-sm sm:text-base mt-1.5 max-w-md">
            {t.featured.subtitle}
          </p>
        </div>
