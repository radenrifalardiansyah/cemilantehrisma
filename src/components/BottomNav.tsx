...
export default function BottomNav() {
  ...
  return (
    <>
      <nav
        className="fixed bottom-0 left-0 right-0 z-50 md:hidden border-t border-green-200"
        style={{ background: '#FFFFFF', paddingBottom: 'env(safe-area-inset-bottom)', boxShadow: '0 -4px 20px rgba(10,10,10,0.12)' }}
      >
        <div>
                  ...
                  >
                    {isActive && (
                      <motion.div
                        ...
                        style={{ background: 'linear-gradient(90deg, #D4AF37, #FCD34D)' }}
              ...
              <div className="px-5 pt-2 pb-6">
                ...
                {!account && (
                  <Link
                    href="/login"
                    onClick={closeAll}
                    className="flex items-center justify-center gap-2 py-3.5 rounded-2xl border-2 border-green-400 shadow-md transition-all"
